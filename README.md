...
```
Please note that if this command doesn't work the first time and gives the error "*This entry is already a member*", just re-run the command. It should work the second time. I'm not sure why this happens.
